...
static struct passwd *test_nss_getpwent(void)
{
...
static void test_nss_setpwent(void)
{
...
static void test_nss_endpwent(void)
{
...
static void test_nss_setgrent(void)
{
...
static void test_nss_endgrent(void)
{
